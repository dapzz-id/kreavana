...
class _PengaturanScreenState extends State<PengaturanScreen> {
  ...
  static const _langLabels = {'id': 'Indonesia', 'en': 'English'};
          ...
          _buildSection(
            ...
            children: [
              _buildSwitchTile(
                ...
                title: 'Mode Gelap',
                subtitle: isDark
                    ? 'Aktif — tampilan gelap nyaman di malam hari'
          ...
          _buildSection(
            ...
            children: [
              _buildNavTile(
                ...
                title: 'Bahasa',
                subtitle:
                    '${_langLabels[_langCode] ?? 'Indonesia'} (${_langCode.toUpperCase()})',
                isDark: isDark,
                trailing: Text(
            ...
            children: [
              ...
              for (final entry in _langLabels.entries)
                ListTile(
                  ...
                  subtitle: Text(
                    entry.key == 'id' ? 'Bahasa Indonesia' : 'English',
                  ),
  ...
  void _showAboutDialog() {
    showAboutDialog(
      ...
      children: const [
        Text(
          'Platform kolaborasi kreatif yang menghubungkan kreator konten dengan klien di seluruh Indonesia.',
        ),
        SizedBox(height: 8),
        Text(
          '© 2025 Kreavana ID. All rights reserved.',
