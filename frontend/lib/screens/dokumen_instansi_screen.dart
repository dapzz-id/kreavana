...
class DokumenInstansiScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dokumen = [
      {
        'name': 'SK Pendirian Instansi.pdf',
        'size': '2.4 MB',
        'date': '15 Jan 2025',
      ...
      {
        'name': 'Rencana Kerja Tahunan 2025.pdf',
        'size': '5.1 MB',
        'date': '10 Feb 2025',
      ...
      {
        'name': 'Dokumen Tender Pengadaan.pdf',
        'size': '1.2 MB',
        'date': '20 Mar 2025',
      ...
      {
        'name': 'SOP Pelaporan Kegiatan.pdf',
        'size': '890 KB',
        'date': '5 Jan 2025',
      ...
      {
        'name': 'Surat Edaran Internal.pdf',
        'size': '450 KB',
        'date': '12 Jun 2025',
