...
class CreatorGeneralDashboardScreen extends StatefulWidget {
  ...
  const CreatorGeneralDashboardScreen({
    super.key,
    required this.user,
  ...
  @override
  State<CreatorGeneralDashboardScreen> createState() =>
      _CreatorGeneralDashboardScreenState();
}

class _CreatorGeneralDashboardScreenState
    extends State<CreatorGeneralDashboardScreen> {
  final GlobalKey _themeBtnKey = GlobalKey();

  static const Color _creatorBlue = Color(0xFF3B82F6);
  static const Color _creatorPurple = Color(0xFF6366F1);
  static const Color _primaryColor = _creatorPurple;
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Cari peluang, proyek, komunitas, atau kreator...',
                        style: TextStyle(
                          fontSize: 13,
                          color: isDark
                              ? AppTheme.textMuted
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Temukan peluang terbaik, kelola proyek Anda, bangun reputasi, dan berkembang bersama ekosistem Kreavana.',
                  style: TextStyle(
                    fontSize: 14,
                  ...
                  children: [
                    ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: _creatorPurple,
  ...
  Widget _buildRecommendationsSection(bool isDark) {
    final recs = [
      ...
      {
        'title': 'Kolaborasi Konten Travel Series',
        'type': 'KOLABORASI',
        'price': 'Kesepakatan Bersama',
        'color': Colors.teal,
      },
      {
        'title': 'Komunitas Fotografi Indonesia',
        'type': 'KOMUNITAS',
        'price': 'Gratis',
        'color': Colors.orange,
      },
  ...
  Widget _buildProjectsAndActivity(bool isDark) {
    final items = [
      ...
      },
      {
        ...
        'client': 'Komunitas Kamera ID',
        'status': 'Deadline',
      },
      {
        'title': 'Konten Instagram Series',
        'client': 'Brand Lokal',
        'status': 'Selesai',
      },
    ];
            ...
            (i) => Padding(
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    radius: 14,
                    backgroundColor: _creatorPurple.withValues(alpha: 0.1),
                    child: const Icon(
                      Icons.work_outline,
                      color: _creatorPurple,
                      size: 14,
  ...
  Widget _buildAgendaCalendar(bool isDark) {
    final agendas = [
      {'date': '24 JUN', 'title': 'Briefing Proyek Video Promosi'},
      {'date': '25 SAB', 'title': 'Workshop Fotografi Street'},
      {'date': '27 SEN', 'title': 'Review Desain Poster Event'},
      {'date': '29 RAB', 'title': 'Deadline Konten Instagram'},
    ];
          ...
          GridView.count(
            ...
            children: List.generate(
              ...
              (index) => Container(
                ...
                child: const Icon(Icons.image, color: _creatorPurple, size: 20),
              ),
            ),
          ),
        ],
  ...
  Widget _buildGrowthRoadmap(bool isDark) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Alur Pertumbuhan Kreator di Kreavana',
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 12),
          Row(
