...
class CreatorEditorDashboardScreen extends StatefulWidget {
  final UserModel user;
  final ValueChanged<UserModel> onUserUpdated;

  const CreatorEditorDashboardScreen({
    super.key,
    required this.user,
  ...
  @override
  State<CreatorEditorDashboardScreen> createState() =>
      _CreatorEditorDashboardScreenState();
}

class _CreatorEditorDashboardScreenState
    extends State<CreatorEditorDashboardScreen> {
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Cari peluang, proyek, atau karya Editor...',
                        style: TextStyle(
                          fontSize: 13,
                          color: isDark
                              ? AppTheme.textMuted
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kelola portofolio, tawaran pekerjaan, dan proyek Editor Anda secara efisien.',
                  style: TextStyle(
                    fontSize: 14,
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('Cari Job Editor'),
  ...
  Widget _buildGrowthRoadmap(bool isDark) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Alur Pertumbuhan Editor di Kreavana',
