...
class CreatorVideograferDashboardScreen extends StatefulWidget {
  final UserModel user;
  final ValueChanged<UserModel> onUserUpdated;

  const CreatorVideograferDashboardScreen({
    super.key,
    required this.user,
  ...
  @override
  State<CreatorVideograferDashboardScreen> createState() =>
      _CreatorVideograferDashboardScreenState();
}

class _CreatorVideograferDashboardScreenState
    extends State<CreatorVideograferDashboardScreen> {
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Cari peluang, proyek, atau karya Videografer...',
                        style: TextStyle(
                          fontSize: 13,
                          color: isDark
                              ? AppTheme.textMuted
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kelola portofolio, tawaran pekerjaan, dan proyek Videografer Anda secara efisien.',
                  style: TextStyle(
                    fontSize: 14,
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('Cari Job Videografer'),
  ...
  Widget _buildRecommendationsSection(bool isDark) {
    final recs = [
      ...
      {
        'title': 'Komunitas Videografer Indonesia',
        'type': 'KOMUNITAS',
        'price': 'Gratis',
        'color': Colors.orange,
      },
  ...
  Widget _buildProjectsAndActivity(bool isDark) {
    final items = [
      {
        'title': 'Job Videografer Professional',
        'client': 'PT Kreasi Muda',
        'status': 'Baru',
      },
      {
        'title': 'Sesi Project Videografer',
        'client': 'Event Musik Jakarta',
        'status': 'Diproses',
      },
      {
        'title': 'Workshop & Training Videografer',
  ...
  Widget _buildAgendaCalendar(bool isDark) {
    final agendas = [
      {'date': '24 JUN', 'title': 'Briefing Project Videografer'},
  ...
  Widget _buildGrowthRoadmap(bool isDark) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Alur Pertumbuhan Videografer di Kreavana',
