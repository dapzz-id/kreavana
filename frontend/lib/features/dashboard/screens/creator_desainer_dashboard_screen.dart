...
class CreatorDesainerDashboardScreen extends StatefulWidget {
  final UserModel user;
  final ValueChanged<UserModel> onUserUpdated;

  const CreatorDesainerDashboardScreen({
    super.key,
    required this.user,
  ...
  @override
  State<CreatorDesainerDashboardScreen> createState() =>
      _CreatorDesainerDashboardScreenState();
}

class _CreatorDesainerDashboardScreenState
    extends State<CreatorDesainerDashboardScreen> {
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Cari peluang, proyek, atau karya Desainer...',
                        style: TextStyle(
                          fontSize: 13,
                          color: isDark
                              ? AppTheme.textMuted
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kelola portofolio, tawaran pekerjaan, dan proyek Desainer Anda secara efisien.',
                  style: TextStyle(
                    fontSize: 14,
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('Cari Job Desainer'),
  ...
  Widget _buildRecommendationsSection(bool isDark) {
    final recs = [
      ...
      {
        'title': 'Komunitas Desainer Indonesia',
        'type': 'KOMUNITAS',
        'price': 'Gratis',
        'color': Colors.orange,
      },
  ...
  Widget _buildProjectsAndActivity(bool isDark) {
    final items = [
      {
        'title': 'Job Desainer Professional',
        'client': 'PT Kreasi Muda',
        'status': 'Baru',
      },
      {
        'title': 'Sesi Project Desainer',
        'client': 'Event Musik Jakarta',
        'status': 'Diproses',
      },
      {
        'title': 'Workshop & Training Desainer',
  ...
  Widget _buildAgendaCalendar(bool isDark) {
    final agendas = [
      {'date': '24 JUN', 'title': 'Briefing Project Desainer'},
  ...
  Widget _buildGrowthRoadmap(bool isDark) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Alur Pertumbuhan Desainer di Kreavana',
