                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                RepaintBoundary(child: _buildCampaignMetrics(isDark)),
                                const SizedBox(height: 24),
                                RepaintBoundary(child: _buildChartSection(isDark)),
                                const SizedBox(height: 24),
                                RepaintBoundary(child: _buildActiveCampaigns(isDark)),
                                const SizedBox(height: 24),
                                RepaintBoundary(child: _buildTalentScoutingGrid(isDark)),
                              ],
                            ),
                          ),
