...
class CreatorDroneDashboardScreen extends StatefulWidget {
  final UserModel user;
  final ValueChanged<UserModel> onUserUpdated;

  const CreatorDroneDashboardScreen({
    super.key,
    required this.user,
  ...
  @override
  State<CreatorDroneDashboardScreen> createState() =>
      _CreatorDroneDashboardScreenState();
}

class _CreatorDroneDashboardScreenState
    extends State<CreatorDroneDashboardScreen> {
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Cari peluang, proyek, atau karya Drone Pilot...',
                        style: TextStyle(
                          fontSize: 13,
                          color: isDark
                              ? AppTheme.textMuted
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kelola portofolio, tawaran pekerjaan, dan proyek Drone Pilot Anda secara efisien.',
                  style: TextStyle(
                    fontSize: 14,
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('Cari Job Drone Pilot'),
  ...
  Widget _buildRecommendationsSection(bool isDark) {
    final recs = [
      ...
      {
        'title': 'Komunitas Drone Pilot Indonesia',
        'type': 'KOMUNITAS',
        'price': 'Gratis',
        'color': Colors.orange,
      },
  ...
  Widget _buildProjectsAndActivity(bool isDark) {
    final items = [
      {
        'title': 'Job Drone Pilot Professional',
        'client': 'PT Kreasi Muda',
        'status': 'Baru',
      },
      {
        'title': 'Sesi Project Drone Pilot',
        'client': 'Event Musik Jakarta',
        'status': 'Diproses',
      },
      {
        'title': 'Workshop & Training Drone Pilot',
  ...
  Widget _buildAgendaCalendar(bool isDark) {
    final agendas = [
      {'date': '24 JUN', 'title': 'Briefing Project Drone Pilot'},
  ...
  Widget _buildGrowthRoadmap(bool isDark) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Alur Pertumbuhan Drone Pilot di Kreavana',
