...
class CreatorContentDashboardScreen extends StatefulWidget {
  ...
  const CreatorContentDashboardScreen({
    super.key,
    required this.user,
  ...
  @override
  State<CreatorContentDashboardScreen> createState() =>
      _CreatorContentDashboardScreenState();
}

class _CreatorContentDashboardScreenState
    extends State<CreatorContentDashboardScreen> {
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Cari peluang, proyek, atau karya Content Creator...',
                        style: TextStyle(
                          fontSize: 13,
                          color: isDark
                              ? AppTheme.textMuted
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kelola portofolio, tawaran pekerjaan, dan proyek Content Creator Anda secara efisien.',
                  style: TextStyle(
                    fontSize: 14,
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('Cari Job Content Creator'),
  ...
  Widget _buildProjectsAndActivity(bool isDark) {
    final items = [
      {
        'title': 'Job Content Creator Professional',
        'client': 'PT Kreasi Muda',
        'status': 'Baru',
      },
      {
        'title': 'Sesi Project Content Creator',
        'client': 'Event Musik Jakarta',
        'status': 'Diproses',
      },
      {
        'title': 'Workshop & Training Content Creator',
  ...
  Widget _buildAgendaCalendar(bool isDark) {
    final agendas = [
      {'date': '24 JUN', 'title': 'Briefing Project Content Creator'},
