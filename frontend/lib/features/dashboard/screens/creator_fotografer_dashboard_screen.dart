...
class CreatorFotograferDashboardScreen extends StatefulWidget {
  ...
  const CreatorFotograferDashboardScreen({
    super.key,
    required this.user,
  ...
  @override
  State<CreatorFotograferDashboardScreen> createState() =>
      _CreatorFotograferDashboardScreenState();
}

class _CreatorFotograferDashboardScreenState
    extends State<CreatorFotograferDashboardScreen> {
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Cari peluang, proyek, atau karya Fotografer...',
                        style: TextStyle(
                          fontSize: 13,
                          color: isDark
                              ? AppTheme.textMuted
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kelola portofolio, tawaran pekerjaan, dan proyek Fotografer Anda secara efisien.',
                  style: TextStyle(
                    fontSize: 14,
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('Cari Job Fotografer'),
  ...
  Widget _buildRecommendationsSection(bool isDark) {
    final recs = [
      ...
      {
        'title': 'Komunitas Fotografer Indonesia',
        'type': 'KOMUNITAS',
        'price': 'Gratis',
        'color': Colors.orange,
      },
  ...
  Widget _buildProjectsAndActivity(bool isDark) {
    final items = [
      {
        'title': 'Job Fotografer Professional',
        'client': 'PT Kreasi Muda',
        'status': 'Baru',
      },
      {
        'title': 'Sesi Project Fotografer',
        'client': 'Event Musik Jakarta',
        'status': 'Diproses',
      },
      {
        'title': 'Workshop & Training Fotografer',
  ...
  Widget _buildAgendaCalendar(bool isDark) {
    final agendas = [
      {'date': '24 JUN', 'title': 'Briefing Project Fotografer'},
  ...
  Widget _buildGrowthRoadmap(bool isDark) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Alur Pertumbuhan Fotografer di Kreavana',
