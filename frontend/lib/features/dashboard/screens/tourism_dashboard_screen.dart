      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildCalItem(
                '18 JUN',
                'Festival Alam Ciwado',
                '08.00 - 17.00 WIB',
              ),
              _buildCalItem(
                '05 JUL',
                'Workshop Fotografi Landscape',
                '07.00 - 12.00 WIB',
              ),
              _buildCalItem(
                '20 JUL',
                'Trip Camping & Api Unggun',
                '15.00 - 10.00 WIB',
              ),
            ],
          ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Rekomendasi untuk Desa Wisata Anda',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13),
              ),
              const SizedBox(height: 4),
              const Text(
