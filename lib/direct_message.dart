...
class ChatListSectionState extends State<ChatListSection> {
  ...
  Future<void> loadChats() async {
    try {
      ...
      final invs = await ApiService.fetchInvitations();
      setState(() {
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        ApiService.respondInvitation(inv['chat_id'].toString(), true).then((_) {
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ApiService.respondInvitation(inv['chat_id'].toString(), false).then((_) {
                          Navigator.pop(context);
                          loadChats();
                        });
                      },
          ...
          FilledButton(
            onPressed: () {
                if (groupNameController.text.isNotEmpty) {
                  ApiService.createGroup(groupNameController.text).then((newGroup) {
                    setState(() {
                ...
                if (index >= chats.length) {
                  ...
                  return Padding(
                    ...
                    child: ListTile(
                      ...
                      onTap: () async {
                          try {
                              final newChat = await ApiService.startPersonalChat(user['userId']);
                              setState(() {
...
class _ChatDetailSectionState extends State<ChatDetailSection> {
  ...
  Future<void> _loadMessages() async {
    ...
    try {
      final msgs = await ApiService.fetchMessages(widget.chat['id'].toString());
      setState(() {
  ...
  Future<void> _sendMessage() async {
    if (_messageController.text.isNotEmpty) {
      ...
      try {
        final newMsg = await ApiService.sendMessage(widget.chat['id'].toString(), text);
        setState(() {
...
class _GroupInfoScreenState extends State<GroupInfoScreen> {
  ...
  Future<void> _loadMembers() async {
    try {
      final msgs = await ApiService.fetchGroupMembers(widget.chat['id'].toString());
      setState(() {
                  ...
                  onPressed: selectedUsers.isEmpty
                      ...
                      : () async {
                          for (var user in selectedUsers) {
                            try {
                              await ApiService.addGroupMember(widget.chat['id'].toString(), user['id']);
                            } catch (e) {
        ...
        children: [
          ...
          ListTile(
            ...
            trailing: Switch(
              ...
              onChanged: (val) {
                ApiService.updateGroupSettings(widget.chat['id'].toString(), val).then((_) {
                  setState(() {
                    onlyAdminCanAdd = val;
                  });
                });
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.pop(context);
                            ApiService.makeAdmin(widget.chat['id'].toString(), m['id'].toString()).then((_) => _loadMembers());
                          },
                        ),
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.pop(context);
                            ApiService.kickMember(widget.chat['id'].toString(), m['id'].toString()).then((_) => _loadMembers());
                          },
                        ),
                      ],
                    ),
          ...
          Padding(
            ...
            child: OutlinedButton.icon(
              onPressed: () {
                ApiService.leaveGroup(widget.chat['id'].toString()).then((_) {
                  Navigator.pop(context);
