...
class StoreJobContractRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'creator_service_id' => 'nullable|uuid|exists:creator_services,id',
            'title' => 'required_without:creator_service_id|string|max:200',
            'description' => 'nullable|string',
            'terms' => 'nullable|string',
            'agreed_price' => 'required_without:creator_service_id|numeric|min:0',
