                    ...
                    <tr>
                        <td style="padding:36px 40px 10px;">
                            ...
                            <p style="margin:0 0 16px; color:#374151; font-size:15px; line-height:1.7;">
                                Terima kasih telah mendaftar di <strong style="color:#312E81;">Kreavana</strong> menggunakan akun Google Anda.
                            </p>
                            <p style="margin:0 0 16px; color:#374151; font-size:15px; line-height:1.7;">
                                Untuk keamanan dan kemudahan Anda saat login secara manual di masa mendatang, kami telah membuatkan sebuah <strong>password sementara</strong> untuk akun Anda:
                            </p>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background-color:#F5F3FF; border:1px solid #C4B5FD; border-radius:8px; padding:18px; text-align:center;">
                                        <span style="font-size:22px; font-weight:700; letter-spacing:3px; color:#1E3A8A;">
                                            {{ $password }}
                                        </span>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F9FAFB; border-radius:6px;">
                                <tr>
                                    <td style="padding:14px 18px; font-size:14px; color:#4B5563;">
                                        Email terdaftar&nbsp;: <strong style="color:#1F2937;">{{ $email }}</strong>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td style="border-left:4px solid #6D28D9; background-color:#F5F3FF; padding:14px 18px; border-radius:0 6px 6px 0;">
                                        <p style="margin:0; font-size:14px; color:#4C1D95; line-height:1.6;">
                                            <strong>Penting:</strong> Demi keamanan akun Anda, kami sangat menyarankan untuk segera login dan mengganti password ini melalui menu <strong>Pengaturan Akun</strong>.
                                        </p>
                                    </td>
                                </tr>
                            </table>
